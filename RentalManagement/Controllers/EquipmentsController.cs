...
namespace RentalManagement.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "equipmentID,category,make,model,serialNum")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "equipmentID,category,make,model,serialNum")] Equipment equipment)
        {
            if (ModelState.IsValid)
            {
